...
$(document).ready(function () {
    $(window).resize(function () {
        $('[cell-sl^="[-aa"]').each(function (index) {

            var absoluteAttr = $(this).attr('cell-sl').replace("-aa:", '-aa'+index+':')
            $(this).attr('cell-sl', '' + absoluteAttr + '')
...
$(document).ready(function () {
    $(window).resize(function () {
        $('[cell-sl^="[-na"]').each(function (index) {

            var normalAttr = $(this).attr('cell-sl').replace("-na:", '-na'+index+':')
            $(this).attr('cell-sl', '' + normalAttr + '')
...
$(document).ready(function () {
    $(window).resize(function () {
        $('[cell-sl^="[-ra"]').each(function (index) {

            var responsiveAttr = $(this).attr('cell-sl').replace("-ra:", '-ra'+index+':')
            $(this).attr('cell-sl', '' + responsiveAttr + '')
...
$(document).ready(function () {
    ...
    $('[cell-rf^="[-fl"]').each(function (index) {
        ...
        var floatAttr = $(this).attr('cell-rf').replace("-fl:", '-fl'+(index+1)+':')
        $(this).attr('cell-rf', '' + floatAttr + '')

        var fl = $(this).attr('cell-rf').match(/[-][f][l](\d{1,})/i);
        var flValue = '[-fl' + fl[1] + ':';

        $('[cell-rf^="' + flValue + '"] > [cell-rf^="[-fa"] > [cell-rf^="[-c"]').each(function (index) {
            $(this).attr("");
            $(this).attr("cell-rf", '[-c' + (index + 1) + ']');
        })
...
//FOR SINGLE FLOAT
$(document).ready(function () {
    $('[cell-fl^="[-fl"]').each(function (index) {

        var floatAttr = $(this).attr('cell-fl').replace("-fl:", '-fl'+index+':')
        $(this).attr('cell-fl', '' + floatAttr + '')

        var fl = $(this).attr('cell-fl').match(/[-][f][l](\d{1,})/i);
        var flValue = '[-fl' + fl[1] + ':';

        $('[cell-fl^="' + flValue + '"] > [cell-fl^="[-fa"] > [cell-fl^="[-c"]').each(function (index) {
            $(this).attr("");
            $(this).attr("cell-fl", '[-c' + (index + 1) + ']');
        })
