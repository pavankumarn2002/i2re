...
$(document).ready(function () {
    $('[cell-mo^="[-cl"]').each(function (index) {
        var closeAttr = $(this).attr('cell-mo').replace("-cl", '-cl'+index+':')
        $(this).attr('cell-mo', '' + closeAttr + '')
    })
    $('[cell-mo^="[-mo"]').each(function (index) {
        
        var modalAttr = $(this).attr('cell-mo').replace("-mo", '-mo'+index+':')
        $(this).attr('cell-mo', '' + modalAttr + '')
...
//For Side Menu
$(document).ready(function () {
    $('[cell-sm^="[-sm"]').each(function (index) {

        var sideAttr = $(this).attr('cell-sm').replace("-sm", '-sm'+index+'')
        $(this).attr('cell-sm', '' + sideAttr + '')
...
$(document).ready(function () {
    paArr=[]
    $('[cell-pa^="[-pa"]').each(function (index) {
        paArr.push(index)
    })
    $('[cell-pa^="[-pa"]').each(function (index) {

        var pageAttr = $(this).attr('cell-pa').replace("-pa:", '-pa'+index+':')
        $(this).attr('cell-pa', '' + pageAttr + '')

        var pa = $(this).attr('cell-pa').match(/[-][p][a](\d{1,})/i);
        var paValue = '[-pa' + pa[1] + ':';

        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ec"]').each(function (i) {
            var ec = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ec"]:eq('+i+')').attr('cell-pa').replace("-ec(", '-ec'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ec"]:eq('+i+')').attr('cell-pa', '' + ec + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ea"]').each(function (i) {
            var ea = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ea"]:eq('+i+')').attr('cell-pa').replace("-ea(", '-ea'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ea"]:eq('+i+')').attr('cell-pa', '' + ea + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-su-ec"]').each(function (i) {
            var suEc = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-su-ec"]:eq('+i+')').attr('cell-pa').replace("-su-ec(", '-su-ec'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-su-ec"]:eq('+i+')').attr('cell-pa', '' + suEc + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-su-ea"]').each(function (i) {
            var suEa = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-su-ea"]:eq('+i+')').attr('cell-pa').replace("-su-ea(", '-su-ea'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-su-ea"]:eq('+i+')').attr('cell-pa', '' + suEa + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-sp-ec"]').each(function (i) {
            var spEc = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-sp-ec"]:eq('+i+')').attr('cell-pa').replace("-sp-ec(", '-sp-ec'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-sp-ec"]:eq('+i+')').attr('cell-pa', '' + spEc + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-sp-ea"]').each(function (i) {
            var spEa = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-sp-ea"]:eq('+i+')').attr('cell-pa').replace("-sp-ea(", '-sp-ea'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-sp-ea"]:eq('+i+')').attr('cell-pa', '' + spEa + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ma-ec"]').each(function (i) {
            var maEc = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ma-ec"]:eq('+i+')').attr('cell-pa').replace("-ma-ec(", '-ma-ec'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ma-ec"]:eq('+i+')').attr('cell-pa', '' + maEc + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ma-ea"]').each(function (i) {
            var maEa = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ma-ea"]:eq('+i+')').attr('cell-pa').replace("-ma-ea(", '-ma-ea'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-ma-ea"]:eq('+i+')').attr('cell-pa', '' + maEa + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-mi-ec"]').each(function (i) {
            var miEc = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-mi-ec"]:eq('+i+')').attr('cell-pa').replace("-mi-ec(", '-mi-ec'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-mi-ec"]:eq('+i+')').attr('cell-pa', '' + miEc + '')
        })
        $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-mi-ea"]').each(function (i) {
            var miEa = $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-mi-ea"]:eq('+i+')').attr('cell-pa').replace("-mi-ea(", '-mi-ea'+paArr[index]+'(')
            $('[cell-pa^="' + paValue + '"]').find('[cell-pa^="[-mi-ea"]:eq('+i+')').attr('cell-pa', '' + miEa + '')
        })
...
// For Accordion
$(document).ready(function () {
    $('[cell-a^="[-ac"]').each(function (index) {

        var accAttr = $(this).attr('cell-a').replace("-ac", '-ac'+index+'')
        $(this).attr('cell-a', '' + accAttr + '')
...
// For Drop Down
$(document).ready(function () {
    $('[cell-dw^="[-dw"]').each(function (index) {

        var dropAttr = $(this).attr('cell-dw').replace("-dw", '-dw'+index+'')
        $(this).attr('cell-dw', '' + dropAttr + '')
...
$(document).ready(function () {
    // For Horizontal Tab
    $('[cell-tb^="[-hz:"]').each(function (index) {

        var tabAttr = $(this).attr('cell-tb').replace("-hz", '-hz'+index+'')
        $(this).attr('cell-tb', '' + tabAttr + '')
...
$(document).ready(function () {
    // For Vertical Tab
    $('[cell-tb^="[-vr"]').each(function (index) {

        var tabAttr = $(this).attr('cell-tb').replace("-vr:", '-vr'+index+':')
        $(this).attr('cell-tb', '' + tabAttr + '')
...
//For Roll Menu
$(document).ready(function () {
    $('[cell-rm^="[-rm"]').each(function (index) {

        var rollAttr = $(this).attr('cell-rm').replace("-rm:", '-rm'+index+':')
        $(this).attr('cell-rm', '' + rollAttr + '')
        ...
        $('[cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] [cell-rm^="[-rb]"]').click(function () {
            ...
            $('[cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] [cell-rm^="[-su-rb]"]:not([cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] #inner-roll-block-x)').removeClass("active");
            $('[cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] [cell-rm^="[-sp-rb]"]:not([cell-rm^="' + rmValue + '"] #sub-roll-block-x)').removeClass("active");
            $('[cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] [cell-rm^="[-ma-rb]"]:not([cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] #sup-roll-block-x)').removeClass("active");
            ...
            $('[cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] [cell-rm^="[-su-rc]"]:not([cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] #inner-roll-content-x)').hide();
            $('[cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] [cell-rm^="[-sp-rc]"]:not([cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] #sub-roll-content-x)').hide();
            $('[cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] [cell-rm^="[-ma-rc]"]:not([cell-rm^="' + rmValue + '"] [cell-rm^="[-ra]"] #sup-roll-content-x)').hide();
