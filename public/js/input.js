...
//For Graphs
$(document).ready(function () {
    $('[cell-gr^="[-gv"]').each(function (index) {

        var graphAttr = $(this).attr('cell-gr').replace("-gv:", '-gv'+index+':')
        $(this).attr('cell-gr', '' + graphAttr + '')
    ...
    $('[cell-gr^="[-gh"]').each(function (index) {

        var graphAttr = $(this).attr('cell-gr').replace("-gh:", '-gh'+index+':')
        $(this).attr('cell-gr', '' + graphAttr + '')
