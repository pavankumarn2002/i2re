                ...
                <div class="title-col">
                    <div cell-Q='[-q-ct]' class=" ">
                        <div class="text">
                            ...
                            <p cell-p='[-b5]' cell-f='[-s25-w7-c2-f5]' cell-ts='[-br5]' cell-t='[-c]'>cell-ts
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div cell-Q='[-q]' class=" ">
                        ...
                        <div cell-c='[-c3]' cell-d='[-db-ln-tn-sn]' class="assigning-values">
                            <div class="actual-col">
                                <div cell-in='[-se-lt]'
                                    class="set ts-values">
                                    <label>cell-ts<span class="star">*</span></label>
                                    <div cell-in='[-sa]' class="">
                                        <div cell-in='[-sb-lr-bo4(5)-r15-bg1-ig2(3)-.bo4(3)-.bg2-.ig3(4)-p10(10)-tc4(5)-ts15(2)]' class=" ">
                                            <select class="" aria-label="Default select example">
                                                ...
                                                <option op="1" value="-l10(2)">-l10(2)</option>
                                                <option op="2" value="-w10(3)">-w10(3)</option>
                                                <option op="3" value="-x10(2)">-x10(2)</option>
                                                <option op="4" value="-y10(4)">-y10(4)</option>
                                                <option op="5" value="-z10(2)">-z10(2)</option>
                                            </select>
                                        </div>
                        ...
                        <div cell-c='[-do-l20-t20-m20-s20]' class="result">
                            <p cell-f='[-s14-w9-c4]' cell-m='[-t45]'>For Text Shadow</p>
                            <div cell-Q='[-q-ct]' class="append-col"></div>
                            <div cell-c='[-d10]' cell-m='[-t45]' cell-p='[-p2]' class=" ">
                                <p cell-f='[-s45-c4]' class="ts-output">Output-1</p>
                            </div>
