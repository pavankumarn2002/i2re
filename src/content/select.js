                ...
                <div class="title-content">
                    <div cell-Q='[-q]' class=" ">
                        <div cell-c='[-c20]' cell-f='[-s12-w9]' class="values">
                            ...
                            <div cell-Q='[-q-sb]' class="text-area">
                                <div cell-c='[-ca]' class="text-col">
                                    <p><span cell-f='[-c2-s16-w7]'>-se</span> = For Input With Icon
                                        Actions </p>
                            ...
                            <div cell-Q='[-q-sb]' class="text-area">
                                <div cell-c='[-ca]' class="text-col">
                                    ...
                                    <p><span cell-f='[-c2-s16-w7]'>-ll</span> = Set Label To Left </p>
                                    <p><span cell-f='[-c2-s16-w7]'>-lr</span> = Set Label To Right </p>
                                    <p><span cell-f='[-c2-s16-w7]'>-c1</span> = Options Display In One
                                        Column</p>
                                    <p><span cell-f='[-c2-s16-w7]'>-c5</span> = Options Display In Five
                                        Column</p>
                                </div>
                                <div cell-c='[-ca]' class="text-col">
                                    <p><span cell-f='[-c2-s16-w7]'>-r10</span> = Border Radius 10x1px=10px
                                ...
                                <div cell-c='[-ca]' class="text-col">
                                    ...
                                    <p><span cell-f='[-c2-s16-w7]'>-is20(20)</span> = Size Of Icon Left
                                        20px & Right 20px</p>
                                    <p><span cell-f='[-c2-s16-w7]'>-tc20(20)</span> = Color Of Icon Left
                                        20px & Right 20px</p>
                        ...
                        <div cell-c='[-c20]' class="result">
                            <p cell-f='[-s14-w9-c4]' cell-m='[-t45]'>For Select Box Actions</p>
                            <div cell-m='[-t45]' cell-in='[-se-ll]' class="">
                                <label>Select Box<span class="star">*</span></label>
                                <div cell-in='[-sa]' class="">
                                    <div cell-in='[-sb-bo4(5)-r15-bg4-ig2(3)-.bo4(2)-.bg2-.ig3(4)-p10(10)-tc5(2)-ts25(5)]'
                                        class="">
