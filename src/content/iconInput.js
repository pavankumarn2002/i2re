                        ...
                        <div cell-c='[-c20]' cell-f='[-s12-w9]' class="values">
                            <div cell-Q='[-q-sb]' class="text-area">
                                <div cell-c='[-ca]' class="text-col">
                                    <p><span cell-f='[-c2-s16-w7]'>-ic</span> = For Input With Icon
                                        Actions </p>
                                ...
                                <div cell-c='[-ca]' class="text-col">
                                    ...
                                    <p><span cell-f='[-c2-s16-w7]'>-.ig2(3)</span>= On Hover BackGround Of
                                        Icon Left Color 2 & Right Color 3 </p>
                                    <p><span cell-f='[-c2-s16-w7]'>-is20(20)</span> = Size Of Icon Left
                                        20px & Right 20px</p>
                                    <p><span cell-f='[-c2-s16-w7]'>-ic20(20)</span> = Color Of Left Icon
                                        2 & Right 3</p>
                                </div>
                                <div cell-c='[-ca]' class="text-col">
                                ...
                                <div cell-c='[-ca]' class="text-col">
                                    <p><span cell-f='[-c2-s16-w7]'>-.ts10(2)</span> = Text Size 10px
                                        Color Two</p>
                                </div>

                            </div>
                            <div cell-c='[-ca-cc]' class="text-col">
                                <p><span cell-f='[-s16-w7-c2-f5]'>cell-in=[-ic]</span> For Input Icon
                                    Actions</p>
                                <p><span cell-f='[-s16-w7-c2-f5]'>cell-in=[-ib]</span> For Input Icon
                                    Box</p>
                                <p><span cell-f='[-s16-w7-c2-f5]'>cell-in=[-li]</span> For Input Left
                                    Icon</p>
                                <p><span cell-f='[-s16-w7-c2-f5]'>cell-in=[-ri]</span> For Input Right
                                    Icon</p>
                            </div>
                        </div>
                        <div cell-c='[-c20]' class="result">
                            <p cell-f='[-s14-w9-c4]' cell-m='[-t45]'>For Input With Icon Actions</p>
                            <div cell-m='[-t45]' cell-in='[-ic-ll]' class="">
                                <label>Input With Icons</label>
                                <div cell-in='[-ib-lr-bo4(5)-r15-bg4-ig2(3)-.bo4(2)-.bg2-.ig3(4)-p10(10)-ic4(5)-ts25(4)]'
                                    class=" ">
