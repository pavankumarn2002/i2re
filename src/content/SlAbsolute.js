...
export class SlAbsolute extends Component {
    componentDidMount() {
                ...
                <div class="title-content">
                    <div cell-Q='[-q]' class=" ">
                        <div cell-c='[-c20]' cell-f='[-s12-w9]' class="values">
                            <p cell-p='[-t5]' cell-f='[-s18-w7-c2-f5]' cell-t='[-c]'>For Absolute Slide Bar
                            </p>
                            <div cell-Q='[-q-sb]' class="text-area">
                                <div cell-c='[-ca]' class="text-col">
                                    <p><span cell-f='[-c2-s16-w7]'>-aa1:</span> = For Absolute Slide Bar Actions And One For Index</p>
                        ...
                        <div cell-c='[-c20]' class="result">
                            <p cell-f='[-s14-w9-c4]' cell-m='[-t45]'>For Absolute Slide Bar</p>
                            <div cell-c='[-c20]' cell-m='[-t45]' class="">
                                <div cell-sl='[-aa:-da5(15)]' class="sl-output">
                                    ...
                                    <div cell-Q='[-q]' class="">
                                        ...
                                        <div cell-sl='[-m]' cell-bg='[-c2]' cell-c='[-co]' cell-p='[-p5]'
                                            ...
                                            <div class="ss-split">
                                                <div class="mid">
                                                    ...
                                                    "read",
                                                    whether
                                                    this object is a work of
                                                    literature, a
                                                    street sign, an arrangement of buildings on a city
                                                    block, or
                                                    styles of
                                                    clothing. It is a coherent
                                                    set of
                            ...
                            <div cell-m='[-t45]' class="code-accord">
                                ...
                                <div class="code-content">
                                    <xmp>
                                        <div cell-c='[-c20]' cell-m='[-t45]' class="">
                                            <div cell-sl='[-aa:-as5(15)-fs1(1)]' class="sl-output">
                                                <div cell-Q='[-q-cc]' cell-p='[-p2]' class="">
                                                    <button
                                                ...
                                                <div cell-Q='[-q]' class="">
                                                    ...
                                                    <div cell-sl='[-m]' cell-bg='[-c2]' cell-c='[-co]'
                                                        cell-p='[-p5]' cell-h='[-h450]' class="column">
                                                    </div>
